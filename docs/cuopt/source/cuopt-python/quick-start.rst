...
After installation, you can verify that NVIDIA cuOpt is working correctly by running the quick start example:

.. literalinclude:: routing/examples/quick_start_example.sh
   :language: bash
   :linenos:
