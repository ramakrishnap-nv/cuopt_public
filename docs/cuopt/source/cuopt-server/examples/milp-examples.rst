...
.. literalinclude:: examples/milp_generic_example.py
    :language: python
    :linenos:
...
.. literalinclude:: examples/milp_incumbent_callback_example.py
    :language: python
    :linenos:
...
.. literalinclude:: examples/milp_abort_job_example.py
   :language: python
   :linenos:
