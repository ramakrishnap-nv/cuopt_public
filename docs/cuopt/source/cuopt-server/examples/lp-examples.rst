...
.. literalinclude:: examples/lp_generic_example.py
    :language: python
    :linenos:
...
.. literalinclude:: examples/lp_warm_start_example.py
    :language: python
    :linenos:
...
.. literalinclude:: examples/lp_mps_file_example.py
    :language: python
    :linenos:
...
.. literalinclude:: examples/lp_datamodel_example.py
    :language: python
    :linenos:
