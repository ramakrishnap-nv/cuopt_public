...
.. literalinclude:: examples/routing_generic_example.py
    :language: python
    :linenos:
...
.. literalinclude:: examples/routing_initial_solution_example.py
    :language: python
    :linenos:
...
* In the case of the server using public certificates, simply enable https.
  ...
  .. literalinclude:: examples/routing_https_example.py
    :language: python
    :linenos:

* In the case of a self-signed certificate, provide the complete path to the certificate.

  .. literalinclude:: examples/routing_https_self_signed_example.py
    :language: python
    :linenos:
